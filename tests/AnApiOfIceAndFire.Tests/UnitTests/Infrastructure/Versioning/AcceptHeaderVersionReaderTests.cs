...
namespace AnApiOfIceAndFire.Tests.UnitTests.Infrastructure.Versioning
{
    public class AcceptHeaderVersionReaderTests
    {
        [Fact]
        public void GivenRequestWithoutAcceptHeader_WhenReadingVersion_ThenNullIsReturned()
        {
        ...
        [Fact]
        public void GivenAcceptHeaderWithIncorrectMediaType_WhenReadingVersion_ThenNullIsReturned()
        {
            var sut = new AcceptHeaderVersionReader();
        ...
        [Fact]
        public void GivenAcceptHeaderWithCorrectMediaTypeButIncorrectParameter_WhenReadingVersion_ThenNullIsReturned()
        {
            var sut = new AcceptHeaderVersionReader();
            var request = new DefaultHttpRequest(new DefaultHttpContext());
        ...
        [Fact]
        public void GivenCorrectHeaderButWithoutVersion_WhenReadingVersion_ThenNullIsReturned()
        {
            var sut = new AcceptHeaderVersionReader();
            var request = new DefaultHttpRequest(new DefaultHttpContext());
        ...
        [Fact]
        public void GivenCorrectHeader_WhenReadingVersion_ThenVersionIsReturned()
        {
            var sut = new AcceptHeaderVersionReader();
            var request = new DefaultHttpRequest(new DefaultHttpContext());
